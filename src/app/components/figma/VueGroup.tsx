import svgPaths from "../../../assets/icons/svg-fmhkt7ya7s";
...
function GroupDropdownHeader() {
  return (
    <div className="bg-white mb-[-1px] relative shrink-0 w-full" data-name="Group Dropdown Header">
...
function GroupDropdownHeader1() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="Group Dropdown Header">
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
...
function Frame56() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative">
      ...
      <ListsGroupItem />
      <div className="bg-[#f0f0f0] relative shrink-0 w-full" data-name="Lists - Group Item">
        <div className="flex flex-row items-center size-full">
...
function Frame62() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between leading-[0] min-h-px min-w-px not-italic relative text-[#606060] text-[10px] tracking-[-0.3px] whitespace-nowrap">
      <div className="flex flex-col font-['Gilroy:Semibold',sans-serif] justify-center relative shrink-0">
        <p className="leading-[12px]">Campaign 2026 Insta</p>
      </div>
      <div className="flex flex-col font-['Gilroy:Bold',sans-serif] justify-center relative shrink-0">
        <p className="leading-[12px]">Edit group</p>
      </div>
    </div>
  );
}

function GroupDropdownHeader2() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="Group Dropdown Header">
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
...
function Frame57() {
  return (
    <div className="bg-[#f0f0f0] content-stretch flex flex-[1_0_0] items-start min-h-px min-w-px overflow-x-clip overflow-y-auto relative w-full">
      <Frame55 />
...
function Frame64() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start justify-center min-h-px min-w-px mr-[-1px] relative">
      <Frame57 />
    </div>
  );
}
...
export default function VueGroup() {
  return (
    <div className="relative rounded-[4px] size-full" data-name="Vue 'GROUP'">
