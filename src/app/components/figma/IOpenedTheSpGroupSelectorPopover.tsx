import svgPaths from "../../../assets/icons/svg-39v0jhdc5j";
...
function DialogXl() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[40px] h-[825px] items-start overflow-clip pb-[32px] pt-[60px] px-[60px] relative rounded-[16px] shrink-0 w-[1360px]" data-name="dialog-XL">
      <Close />
      <Title />
      <Frame6 />
    </div>
...
function OverlayPaddings() {
  return (
    <div className="bg-[rgba(29,29,27,0.9)] flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="overlay+paddings">
...
function DialogsXl() {
  return (
    <div className="absolute content-stretch flex flex-col h-[919px] items-start left-0 overflow-clip top-0 w-[1440px]" data-name="dialogs/XL">
      <OverlayPaddings />
    </div>
  );
}

export default function IOpenedTheSpGroupSelectorPopover() {
  return (
    <div className="content-stretch flex items-start pl-[24px] pr-[20px] pt-[12px] relative size-full" data-name="I opened the SP / Group selector popover">
      <DialogsXl />
    </div>
  );
}