import svgPaths from "../../../assets/icons/svg-kpe1f88jyy";
...
function Frame80() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-[335px]">
      <Frame77 />
      <div className="flex flex-col font-['Gilroy:Semibold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#a0a0a0] text-[10px] tracking-[-0.3px] whitespace-nowrap">
        <p className="leading-[12px]">Start typing ...</p>
      </div>
    </div>
  );
}
...
function Frame76() {
  return (
    <div className="content-stretch flex h-[356px] items-start overflow-x-clip overflow-y-auto relative shrink-0 w-full">
      <Frame71 />
...
export default function VueAllSps() {
  return (
    <div className="relative rounded-[4px] size-full" data-name="Vue 'ALL SPS'">
