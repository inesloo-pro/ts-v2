import svgPaths from "../../../assets/icons/svg-bp25h0q4oc";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-start justify-center leading-[0] not-italic relative shrink-0 text-[#606060] tracking-[-0.3px] whitespace-nowrap">
      ...
      <div className="flex flex-col font-['Gilroy:Medium',sans-serif] justify-center relative shrink-0 text-[10px]">
        <p className="leading-[12px]">120 profiles</p>
      </div>
    </div>
  );
}
...
function DropdownUpdateSpSelection1() {
  return (
    <div className="flex-[1_0_0] h-full min-h-px min-w-px mr-[-1px] relative rounded-br-[4px] rounded-tr-[4px]" data-name="Dropdown : Update SP Selection">
      <div className="content-stretch flex flex-col items-center overflow-clip relative rounded-[inherit] size-full">
        <Frame74 />
        <div className="bg-[#e0e0e0] h-[32px] relative rounded-[3px] shrink-0 w-full" data-name="01-UI_Light/Buttons">
          <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
            <div className="content-stretch flex items-center justify-center px-[20px] py-[12px] relative size-full">
              <div className="flex flex-col font-['Gilroy:Semibold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#a0a0a0] text-[12px] tracking-[-0.3px] whitespace-nowrap">
                <p className="leading-[14px]">Groups are limited to 50 social profiles</p>
              </div>
            </div>
          </div>
        </div>
...
export default function RevampedComponent() {
  return (
    <div className="content-stretch flex items-center pr-px relative shadow-[10px_4px_60px_0px_rgba(0,0,0,0.25)] size-full" data-name="Revamped Component">
